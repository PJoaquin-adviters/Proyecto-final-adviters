...
export const newLicense = (data) => {
  ...
  if (data.idLicenceType < 0)
    errors.push("Debes ingresar un tipo de licencia.");
  ...
  if (data.startDate < new Date())
    errors.push("La fecha de inicio de licencia no puede haber pasado.");
  if (
    !formatoFechaEsValido(data.startDate) ||
    !formatoFechaEsValido(data.endDate)
  )
    errors.push(
  ...
  if (
    ...
    errors.push(
      "La licencia cargada no puede exceder el número de días totales"
    );
